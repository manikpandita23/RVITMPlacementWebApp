...
<body>
    ...
    <div class="content" style="margin-top: 110px; margin-left: 60px; width: 400px;">
        <h3>About Us</h3>
    	<p class="lead"><b>RVITM Placement Management System</b> is an application mainly developed for the college to add and maintain companies 
