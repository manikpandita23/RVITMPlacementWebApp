...
<head>
  ...
  <title>rvitmplacement | Welcome</title>
...
<body>
  ...
  <div class="content" style="margin-top: 160px; margin-left: 10px;">
    <h1 style="margin-left: 30px; font-size: 64px;"><b> </b><br>  RVITM PLACEMENT <br><b> MANAGEMENT </b><br> SYSTEM</h1> <br>
  </div>
  <div id="users" style="z-index: 1; position: relative; margin-top: 130vh;">
    ...
    <a href="login.php" class="btn btn-outline-light my-2 my-sm-0"
      style="border-radius: 50px; border-width: 2px; font-weight: bold;" id="loginnav">LOGIN</a>
    <div class="container">
        ...
        <div class="card" style="width: 400px; background: none; border: none;" align="center">
          ...
          <div class="card-body">
            <h2 class="card-title" align="center"><a href="login.php">Admin</a></h5>
              <p class="card-text"><small class="text-muted">Student Placement Coordinator</small></p>
          </div>
        </div>
        <div class="card" style="width: 400px; background: none; border: none;" align="center">
  ...
  <div id="contact" style="z-index: 1; position: absolute; margin-left:2%; margin-top: 30vh;">
    <div class="form-row">
      <div class="form-group" style="margin-left:270px; margin-top: 200px;">
        <h1>Contact Us</h1>
        <p class="lead">&nbsp;<i class="fas fa-mobile"></i>&nbsp; (+91) 7051131571</p>
        <p class="lead">&nbsp;<i class="fas fa-at"></i>&nbsp; manikpandita23@gmail.com</p>
      </div>
  ...
  if ($num_rows > 0) {
    ...
    // Proceed with displaying user information
    // For example:
    echo "Welcome, " . $row['fname'] . "!"; // Display user's first name
  } else {
