...
<body>
    <div>
        <img id="img2" src="../images/feedicon.png" width="550px"
            style="position: absolute; position: fixed; z-index: 1; margin-left: 60%; margin-top: 18vh;">
    </div>
                ...
                <div class="card" style="border: none;">
                    <div class="card-body">
                        ...
                        if (!$res) {
                            ...
                            // Query successful, continue processing the result
                        ...
                        if ($rescheck > 0) {
                            while ($row = mysqli_fetch_assoc($res)) {
                                ?>
                                <h5 class="card-title"><i class="far fa-user-circle"></i>&nbsp;
                                    <?php echo $row['user']; ?>
                                </h5>
                                <p class="card-text">
